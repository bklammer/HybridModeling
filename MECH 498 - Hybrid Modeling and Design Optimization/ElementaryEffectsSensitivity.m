...
average = [0.0082584, 0.6, 6000000, 0.0000138, 0.3, 0.062181, 0.02965, ...
    4.3388, 100000, 930, 0.000155, 0.5, 1300, 86652, 301, 1.05, 0.818, 0.9, 1];
deviation = [0.02, 0.1, 0.05, 0.1, 0.01, 0.025, 0.075, 0.14, 0.5, 0.032, 0.1, ...
    0.01, 0.05, 0.1, 0.02, 0.05, 0.1, 0.05, 0.1];
